...
$(document).ready(function ($) {
    ...
    $('a[name="exportBtn"]').on("click", function () {
        ...
        $('#jt_trans_backup_table').DataTable().rows({ search: "applied", page: "current" }).nodes().to$().each(function () {
    ...
    function updateCheckboxesOnOtherPages(isChecked) {
        ...
        var cells = $('#jt_trans_backup_table').DataTable().rows({ page: "current" }).nodes();

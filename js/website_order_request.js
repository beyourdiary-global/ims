...
$(document).ready(function () {
  function bindHiddenReset(textSelector, hiddenSelector) {
    $(textSelector).on("input", function () {
      $(hiddenSelector).val("");
    });
  }

  bindHiddenReset("#wor_pkg", "#wor_pkg_hidden");
  bindHiddenReset("#wor_country", "#wor_country_hidden");
  bindHiddenReset("#wor_currency", "#wor_currency_hidden");
  bindHiddenReset("#wor_pay", "#wor_pay_hidden");
  bindHiddenReset("#wor_cust_id", "#wor_cust_id_hidden");
...
$(".submitBtn").on("click", () => {
  ...
  if (
    $("#wor_order_id").val() === "" ||
    $("#wor_order_id").val() === null ||
    $("#wor_order_id").val() === undefined
  ) {
    order_id_chk = 0;
    $("#wor_order_id").after(
  ...
  if (
    $("#wor_pkg_hidden").val() == "" ||
    $("#wor_pkg_hidden").val() == "0" ||
    $("#wor_pkg_hidden").val() === null ||
    $("#wor_pkg_hidden").val() === undefined
  ) {
    pkg_chk = 0;
    $("#wor_pkg").after(
  ...
  if (
    $("#wor_country_hidden").val() == "" ||
    $("#wor_country_hidden").val() == "0" ||
    $("#wor_country_hidden").val() === null ||
    $("#wor_country_hidden").val() === undefined
  ) {
    country_chk = 0;
    $("#wor_country").after(
  ...
  if (
    $("#wor_currency_hidden").val() == "" ||
    $("#wor_currency_hidden").val() == "0" ||
    $("#wor_currency_hidden").val() === null ||
    $("#wor_currency_hidden").val() === undefined
  ) {
    currency_chk = 0;
    $("#wor_currency").after(
  ...
  if (
    $("#wor_pay_hidden").val() == "" ||
    $("#wor_pay_hidden").val() == "0" ||
    $("#wor_pay_hidden").val() === null ||
    $("#wor_pay_hidden").val() === undefined
  ) {
    pay_chk = 0;
    $("#wor_pay").after(
  ...
  if (
    $("#wor_cust_id_hidden").val() == "" ||
    $("#wor_cust_id_hidden").val() == "0" ||
    $("#wor_cust_id_hidden").val() === null ||
    $("#wor_cust_id_hidden").val() === undefined
  ) {
    cust_id_chk = 0;
    $("#wor_cust_id").after(
  ...
  if ($("#wor_customer_id").val() === "Create New Customer ID") {
    if (
      $("#wor_customer_id").val() === "" ||
      $("#wor_customer_id").val() === null ||
      $("#wor_customer_id").val() === undefined
    ) {
      customer_id_chk = 0;
  ...
  if ($("#wor_cust_brand").val() === "Create New Customer ID") {
    if (
      $("#wor_cust_brand_hidden").val() == "" ||
      $("#wor_cust_brand_hidden").val() == "0" ||
      $("#wor_cust_brand_hidden").val() === null ||
      $("#wor_cust_brand_hidden").val() === undefined
    ) {
      cust_brand_chk = 0;
  ...
  if ($("#wor_cust_series").val() === "Create New Customer ID") {
    if (
      $("#wor_cust_series_hidden").val() == "" ||
      $("#wor_cust_series_hidden").val() == "0" ||
      $("#wor_cust_series_hidden").val() === null ||
      $("#wor_cust_series_hidden").val() === undefined
    ) {
      cust_series_chk = 0;
  ...
  if ($("#wor_cust_ship_name").val() === "Create New Customer ID") {
    if (
      $("#wor_cust_ship_name").val() === "" ||
      $("#wor_cust_ship_name").val() === null ||
      $("#wor_cust_ship_name").val() === undefined
    ) {
  ...
  if ($("#wor_cust_ship_address").val() === "Create New Customer ID") {
    if (
      $("#wor_cust_ship_address").val() === "" ||
      $("#wor_cust_ship_address").val() === null ||
      $("#wor_cust_ship_address").val() === undefined
    ) {
  ...
  if ($("#wor_cust_ship_contact").val() === "Create New Customer ID") {
    if (
      $("#wor_cust_ship_contact").val() === "" ||
      $("#wor_cust_ship_contact").val() === null ||
      $("#wor_cust_ship_contact").val() === undefined
    ) {
  ...
  if (
    $("#wor_cust_name").val() == "" ||
    $("#wor_cust_name").val() == "0" ||
    $("#wor_cust_name").val() === null ||
    $("#wor_cust_name").val() === undefined
  ) {
    cust_name_chk = 0;
    $("#wor_cust_name").after(
  ...
  if (
    $("#wor_cust_email").val() == "" ||
    $("#wor_cust_email").val() == "0" ||
    $("#wor_cust_email").val() === null ||
    $("#wor_cust_email").val() === undefined
  ) {
    cust_email_chk = 0;
    ...
    cust_email_chk = 0;
    $("#wor_cust_email").after(
      '<span class="error-message wor-cust-email-err">Invalid email format!</span>',
    );
  } else {
    $(".wor-cust-email-err").remove();
    cust_email_chk = 1;
  ...
  if (
    $("#wor_cust_birthday").val() == "" ||
    $("#wor_cust_birthday").val() == "0" ||
    $("#wor_cust_birthday").val() === null ||
    $("#wor_cust_birthday").val() === undefined
  ) {
    cust_birthday_chk = 0;
  ...
  if (
    $("#wor_shipping_name").val() == "" ||
    $("#wor_shipping_name").val() == "0" ||
    $("#wor_shipping_name").val() === null ||
    $("#wor_shipping_name").val() === undefined
  ) {
    shipping_name_chk = 0;
  ...
  if (
    $("#wor_shipping_address").val() == "" ||
    $("#wor_shipping_address").val() == "0" ||
    $("#wor_shipping_address").val() === null ||
    $("#wor_shipping_address").val() === undefined
  ) {
  ...
  if (
    $("#wor_shipping_contact").val() == "" ||
    $("#wor_shipping_contact").val() == "0" ||
    $("#wor_shipping_contact").val() === null ||
    $("#wor_shipping_contact").val() === undefined
  ) {

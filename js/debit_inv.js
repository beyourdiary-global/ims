...
function AddRow() {
  ...
  var cell = $(row.insertCell(-1));
  cell.html(
    '<label class="form-label form_lbl" for="prod_desc_' +
      numbering +
      '" hidden>Description<span class="required-dot">*</span></label>' +
      '<input type="text" name="prod_desc[]" id="prod_desc_' +
      numbering +
      '" value="" onkeyup="prodInfo(this)" required  >' +
      '<input type="hidden" name="prod_val[]" id="prod_val_' +
      numbering +
  ...
  cell.html(
    '<label class="form-label form_lbl" for="price_' +
      numbering +
      '" hidden>Price<span class="required-dot">*</span></label>' +
      '<input type="text" name="price[]" id="price_' +
      numbering +
      '" value="" required  oninput="calculateAmount(' +
      numbering +
      ')">',
  );
  cell = $(row.insertCell(-1));
  cell.html(
    '<label class="form-label form_lbl" for="quantity_' +
      numbering +
      '" hidden>Quantity<span class="required-dot">*</span></label>' +
  ...
  cell = $(row.insertCell(-1));
  cell.html(
    '<input  class="readonlyInput" type="text" name="amount[]" id="amount_' +
      numbering +
      '" value="">',
  );

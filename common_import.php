...
$canShopeeAdsExport = is_array($shopeeAdsPinAccess) && isActionAllowed('Export', $shopeeAdsPinAccess);
$canFacebookAdsImport = is_array($facebookAdsPinAccess) && isActionAllowed('Import', $facebookAdsPinAccess);
$canFacebookAdsExport = is_array($facebookAdsPinAccess) && isActionAllowed('Export', $facebookAdsPinAccess);
$canShopeeOrderImport = is_array($shopeeOrderPinAccess) && isActionAllowed('Import', $shopeeOrderPinAccess);
$canShopeeOrderExport = is_array($shopeeOrderPinAccess) && isActionAllowed('Export', $shopeeOrderPinAccess);
$canPackageImport = is_array($packagePinAccess) && isActionAllowed('Import', $packagePinAccess);
$canPackageExport = is_array($packagePinAccess) && isActionAllowed('Export', $packagePinAccess);
$canStockInImport = is_array($stockInPinAccess) && isActionAllowed('Import', $stockInPinAccess);
$canStockInExport = is_array($stockInPinAccess) && isActionAllowed('Export', $stockInPinAccess);
$canProductImport = is_array($productPinAccess) && isActionAllowed('Import', $productPinAccess);
$canProductExport = is_array($productPinAccess) && isActionAllowed('Export', $productPinAccess);
...
$shortcutCards = array(
    array(
        ...
        'canViewBack' => ($canShopeeAdsImport || $canShopeeAdsExport),
    ...
    array(
        ...
        'canViewBack' => ($canFacebookAdsImport || $canFacebookAdsExport),
    ...
    array(
        ...
        'canViewBack' => ($canShopeeOrderImport || $canShopeeOrderExport),
    ...
    array(
        ...
        'canViewBack' => ($canPackageImport || $canPackageExport),
    ...
    array(
        ...
        'canViewBack' => ($canStockInImport || $canStockInExport),
    ...
    array(
        ...
        'canViewBack' => ($canProductImport || $canProductExport),

...
$companyTbl = COMPANY;
$redirectPage = $SITEURL . '/stock/purchase_order_table.php';
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" autocomplete="off">
                            ...
                            <div class="import-preview-actions mt-4">
                                ...
                                <a href="purchase_order_import.php" class="btn btn-sm btn-rounded btn-secondary import-preview-cancel">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>

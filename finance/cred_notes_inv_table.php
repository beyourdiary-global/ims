...
$redirectPage = $SITEURL . '/finance/cred_notes_inv.php';
                            ...
                            <tr>
                                ...
                                <td scope="row">
                                    <div style="text-align: center;">
                                        ...
                                        <a class="icon-buttons rounded p-1 bg-label-info" target="_blank" href="<?= htmlspecialchars((string) ('generate_pdf.php?id=' . (int) $row['id'] . '&act=' . $act_2), ENT_QUOTES, 'UTF-8') ?>"
                                            title="Download"><i class="fas fa-download bg-label-info"></i></a>

                                        <?php if (isActionAllowed("Delete", $pinAccess)): ?>
                                            <a class="icon-buttons rounded p-1 bg-label-danger"
                                                onclick="confirmationDialog(<?= json_encode((string) $row['id']) ?>,[<?= json_encode((string) $row['invoice']) ?>],<?= json_encode((string) $pageTitle) ?>,<?= json_encode((string) $redirectPage) ?>,<?= json_encode((string) ($SITEURL . '/cred_notes_inv_table.php')) ?>,'D')"

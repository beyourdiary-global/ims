...
define('MEMBER_POINT_LEDGER', 'member_point_ledger');
define('MEMBER_POINT_TRANSACTION', 'membership_point_transaction');
define('MEMBER_POINT_MEMBER_STATE', 'membership_point_member_state');
define('MEMBER_REDEEM_SETTING', 'member_redeem_setting');
define('MEMBER_BONUS_TIER_SETTING', 'member_bonus_tier_setting');
define('MEMBER_BONUS_SPECIAL_SETTING', 'member_bonus_special_setting');

...
$redirectPage = $SITEURL . '/product/product.php';
$deleteRedirectPage = $SITEURL . '/product/product_table.php';
...
if (!empty($checkboxValues)) {
    if (!isActionAllowed("Export", $pinAccess)) {
        ...
        ob_end_clean();
        echo "<script>alert('You do not have permission to export this page.'); location.href='" . $SITEURL . "/product/product_table.php';</script>";
        exit;
    }

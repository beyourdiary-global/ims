...
$redirectPage = $SITEURL . '/settings/company.php';
$deleteRedirectPage = $SITEURL . '/settings/company_table.php';
$import_page = $SITEURL . '/import/company_import.php';
...
if ($actionBtn === 'exportData' && !empty($selectedExportIds)) {
    if (!isActionAllowed("Export", $pinAccess)) {
        ob_end_clean();
        echo "<script>alert('You do not have permission to export this page.'); location.href='" . $SITEURL . "/settings/company_table.php';</script>";
        exit;
    }
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td scope="row" class="btn-container">
                                        ...
                                        <?php renderDeleteButton($pinAccess, $row['id'], $row['name'], isset($row['remark']) ? $row['remark'] : '', $pageTitle, $redirectPage, $deleteRedirectPage); ?>
                                    </td>

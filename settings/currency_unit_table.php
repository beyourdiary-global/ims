...
$redirectPage = $SITEURL . '/settings/currency_unit.php';
$deleteRedirectPage = $SITEURL . '/settings/currency_unit_table.php';
                        ...
                        while ($row = $result->fetch_assoc()) {
                            if (isset($row['unit'],$row['id']) && !empty($row['unit'])) { ?>
                                <tr>
                                    ...
                                    <?php renderDeleteButton($pinAccess, $row['id'], $row['unit'], $row['remark'], $pageTitle, $redirectPage, $deleteRedirectPage); ?>
                                    </td>
                                    <td scope="row"><?= htmlspecialchars((string) $row['unit'], ENT_QUOTES, 'UTF-8') ?></td>

        ...
        <div class="col-12 col-md-11">
            ...
            if (!$result) {
                ...
                <div class="row mb-3">
                    ...
                    <a id='resetButton' href="../reset.php?redirect=shopee/shopee_order_req_income_table_summary.php" class="btn btn-sm btn-rounded btn-primary"> <i class="fa fa-refresh"></i> Reset </a>
                    </div>
                </div>

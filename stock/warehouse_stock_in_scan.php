                                ...
                                if (!empty($omsProductSummaryRows)) {
                                    ...
                                    foreach ($omsProductSummaryRows as $omsProductRow) {
                                        ...
                                        if ($omsCanEditProduct && $omsProductId > 0) {
                                            $omsProductParts[] = '<a href="' . htmlspecialchars($SITEURL . '/product/product.php?id=' . $omsProductId . '&act=E', ENT_QUOTES, 'UTF-8') . '" target="_blank" rel="noopener noreferrer">' . htmlspecialchars($omsProductLabel, ENT_QUOTES, 'UTF-8') . '</a>';
                                        } else {
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php if ($omsCanEditProduct && $productId > 0) { ?>
                                                <a href="<?= htmlspecialchars($SITEURL . '/product/product.php?id=' . $productId . '&act=E') ?>" target="_blank" rel="noopener noreferrer"><?= htmlspecialchars($productLine) ?></a>
                                            <?php } else { ?>

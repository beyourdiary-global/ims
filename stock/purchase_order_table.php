...
$redirectPage = $SITEURL . '/stock/purchase_order.php';
$deleteRedirectPage = $SITEURL . '/stock/purchase_order_table.php';
$import_page = $SITEURL . '/import/purchase_order_import.php';
...
if ($actionBtn === 'exportData' && !empty($selectedExportIds)) {
    if (!isActionAllowed("Export", $pinAccess)) {
        ob_end_clean();
        echo "<script>alert('You do not have permission to export this page.'); location.href='" . $SITEURL . "/stock/purchase_order_table.php';</script>";
        exit;
    }
...
<body>
    ...
    <script src="<?= $SITEURL ?>/js/stock/purchase_order_table.js"></script>
</body>
</html>

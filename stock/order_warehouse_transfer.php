    ...
    <div id="formContainer" class="container mt-2" style="max-width:1400px;">
        ...
        <div class="card owt-card mb-4">
            <div class="card-body">
                ...
                <form class="row g-3 owt-search-form" method="post" action="<?= $SITEURL ?>/stock/order_warehouse_transfer_process.php" id="owtSearchForm" novalidate>
                            ...
                            <?php foreach ($searchResults as $result) { ?>
                                ...
                                <div class="card owt-card mb-3">
                                    <div class="card-body">
                                        ...
                                        <?php } else { ?>
                                            <form class="mt-4 owt-actions" method="post" action="<?= $SITEURL ?>/stock/order_warehouse_transfer_process.php">
...
<script>
    window.orderWarehouseTransferConfig = {
        ...
        flashPopupReturnUrl: <?= json_encode($SITEURL . '/stock/order_warehouse_transfer.php') ?>
    };
</script>

...
$redirectPage = $SITEURL . '/customer/fb_cust_deals_table.php';
    ...
    <div class="page-load-cover">
        ...
        <div id="formContainer" class="container d-flex justify-content-center">
            <div class="col-6 col-md-6 formWidthAdjust">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="customer-field-with-label">
                                    <input class="form-control" type="text" name="fcb_name" id="fcb_name" value="<?php echo !empty($echoVal) ? $row['name'] : '' ?>" <?php if ($act == '')
                                        echo 'disabled' ?>>
                                    <?php echo customerLabelRenderInlineSegmentationBadge($facebookCustomerLabelMeta); ?>
                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-sm btn-rounded btn-primary" style="white-space:nowrap;"
                                                               href="<?= $SITEURL . '/customer/fb_cust_deals.php?id=' . (int) $dataId . '&act=' . $act_2 . '&open_order_id=' . $orderId ?>">
                                                                Show Order Detail
                                                            </a>
                                                        </td>
                ...
                <?php
                if ($dataId) {
                    $customerLogReturnUrl = $SITEURL . '/customer/fb_cust_deals.php?id=' . (int) $dataId;
                    if ($act !== '') {

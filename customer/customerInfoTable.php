...
$redirectPage = $SITEURL . '/customer/customerInfo.php';
$deleteRedirectPage = $SITEURL . '/customer/customerInfoTable.php';
                                ...
                                if (isset($row['name'], $row['id']) && !empty($row['name'])) { ?>
                                    ...
                                    <tr <?= $filterAttributes ?>>
                                        ...
                                        <td scope="row" class="btn-container">
                                            ...
                                            <?php renderDeleteButton($pinAccess, $row['id'], $row['last_name'], $row['email'], $pageTitle, $redirectPage, $deleteRedirectPage); ?>
                                            <?php

...
$redirectPage = $SITEURL . '/customer/website_customer_record.php';
$deleteRedirectPage = $SITEURL . '/customer/website_customer_record_table.php';
...
$customerTagActivityMap = customerTagGetAssignmentActivityMap($connect, 'website', $customerIds);
?>

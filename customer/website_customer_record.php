    ...
    <?php } ?>
        ...
        <input type="hidden" name="wcr_series_hidden" id="wcr_series_hidden" value="<?php echo (isset($row['series'])) ? $row['series'] : ''; ?>">
            ...
            <?php } ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-sm btn-rounded btn-primary" style="white-space:nowrap;"
                                                               href="<?= $SITEURL . '/customer/website_customer_record.php?id=' . (int) $dataId . '&act=' . $act_2 . '&open_order_id=' . $orderId ?>">
                                                                Show Order Detail
                                                            </a>
                                                        </td>
                ...
                <?php
                if ($dataId) {
                    $customerLogReturnUrl = $SITEURL . '/customer/website_customer_record.php?id=' . (int) $dataId;
                    if ($act !== '') {

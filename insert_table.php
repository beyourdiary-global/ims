...
if ($conn->select_db($db_fin)) {
    ...
    $shouldRunForceToPackBatch = (
        (defined('RUN_SHOPEE_OMS_FORCE_TO_PACK_20260526') && RUN_SHOPEE_OMS_FORCE_TO_PACK_20260526)
        || (isset($_GET['run_shopee_force_to_pack_20260526']) && trim((string) $_GET['run_shopee_force_to_pack_20260526']) === '1')
    );

    if (!$shouldRunForceToPackBatch) {
        echo "<p style='color:orange;'>Skipped one-time Shopee To Pack batch for 2026-05-26. Add `?run_shopee_force_to_pack_20260526=1` or define `RUN_SHOPEE_OMS_FORCE_TO_PACK_20260526` to run it explicitly.</p>";
    } else {

...
$redirectPage = $SITEURL . '/users/pin.php';
$deleteRedirectPage = $SITEURL . '/users/pin_table.php';
                        ...
                        while ($row = $result->fetch_assoc()) {
                            if (isset($row['name'],$row['id']) && !empty($row['name'])) { ?>
                                <tr>
                                    ...
                                    <td scope="row"><?= htmlspecialchars((string) $row['name'], ENT_QUOTES, 'UTF-8') ?> (<?= htmlspecialchars((string) $row['id'], ENT_QUOTES, 'UTF-8') ?>)</td>

...
$menuList = array(
    ...
    array(
        ...
        'expand' => array(
            ...
            array('Stock Order Request', 'mdi mdi-note-text-outline', $SITEURL . '/finance/stock_order_request_table.php', '104'),
            array('Order Process List', 'mdi mdi-note-text-outline', $SITEURL . '/finance/order_process_list.php', '95'),
        ),
        'pin' => array('69', '86', '92', '93', '95', '124')
    ),
    array(
        'Distributor',
        'mdi mdi-account-outline',
    ...
    array(
        ...
        'expand' => array(
            ...
            array('Stock In', 'mdi mdi-tray-arrow-down', $SITEURL . '/warehouse_stock_in_table.php', '104'),
